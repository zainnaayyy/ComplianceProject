...
for (let i = 0; i < 100; i++) {
  originData.push({
    ...
    lob: `Welcome`,
    // address: `Available`,
    site: `www.something.com ${i}`,
    email: `someone@something.com ${i}`,
    status: `active`,
  });
}
      ...
      <div className='flex justify-between'>
        ...
        <div className='flex'>
          <div class='group/nui-input relative'>
            ...
            <div class='h-10 w-10 dark:text-black text-muted-400 group-focus-within/nui-input:text-primary-500 absolute start-0 top-0 flex items-center justify-center transition-colors duration-300 peer-disabled:cursor-not-allowed peer-disabled:opacity-75'>
              <svg
                          ...
                          <table class='divide-muted-200 dark:divide-muted-700 min-w-full table-fixed divide-y'>
                                    ...
                                    <div class='relative inline-flex items-start gap-1'>
                                      <div class='rounded nui-focus group/nui-checkbox relative flex h-5 w-5 shrink-0 cursor-pointer items-center justify-center overflow-hidden'>
                                        <input
                                          ...
                                          false-value='false'
                                          name='table-1-main'
                                          class='text-primary-500 peer absolute z-20 h-5 w-5 cursor-pointer opacity-0'
                                          type='checkbox'
                                        />
                            ...
                            <tbody class='divide-muted-200 dark:divide-muted-700 dark:bg-muted-800 divide-y bg-white'>
                              ...
                              <tr class='hover:bg-muted-50 dark:hover:bg-muted-900 transition-colors duration-300'>
                                ...
                                <td class='font-alt whitespace-nowrap text-sm text-muted-800 dark:text-white p-4'>
                                  <div class='flex items-center'>
                                    <div class='relative inline-flex shrink-0 items-center justify-center outline-none h-10 w-10 rounded-full bg-primary-500/20 text-primary-500'>
                                      <div class='rounded-full flex h-full w-full items-center justify-center overflow-hidden text-center transition-all duration-300'>
                                        <img
                    ...
                    <ul class='border-muted-200 bg-muted-100 dark:border-muted-600 dark:bg-muted-700 mb-4 inline-flex flex-wrap gap-2 border p-1 md:mb-0 md:gap-1 rounded-xl'>
                      <li>
                        <a
                          ...
                          class='router-link-active router-link-exact-active flex h-10 w-10 items-center justify-center border font-sans text-sm transition-all duration-300 bg-primary-500 border-primary-500 shadow-primary-500/50 dark:shadow-primary-500/20 text-white shadow-sm rounded-xl'
                          tabindex='0'
                        >
                          1
                        </a>
