...
export const isEmptyZero = (str) => {
    return (!str || str == '' || str === '' || str === "" || str.length === 0 || str == 0 || str == "0" || str == 0 || str == " " || str == "" || str == "NaN" || str == NaN || str == "Infinity" || str == Infinity || str == "undefined" || str == undefined  || str == "undefined" || 
    str == "Invalid date" || str == "Invalid Date" || str == "false" || str == false
);
}
export const isEmptyTime = (str) => {
